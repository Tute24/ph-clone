    ...
    <dialog className="rounded-md sm:w-2/6" ref={modalDelete}>
      ...
      <div className="px-2 sm:px-10 sm:py-3 flex justify-center flex-col items-center">
        <h2 className="font-bold text-sm sm:text-base py-2  ">
          Are you sure you want to delete <span className='text-darkerOrange'>{dialogRef?.productName}</span>?
        </h2>
        <h2 className='font-bold'>
            This action is permanent and cannot be undone.
        </h2>
        <button onClick={deleteReq} className='bg-orange1 hover:bg-darkerOrange rounded-full text-white px-3 mt-3 mb-3 font-bold'>Delete</button>
      </div>
    </dialog>
  )
}